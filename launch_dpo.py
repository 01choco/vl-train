...
def main():
    ...
    parser.add_argument("-v", "--visible", required=True, type=str, help="Visible devices")
    parser.add_argument(
        "--gpus",
        default=None,
        type=int,
    ...
    job = executor.submit(lambda: dpo_task(nodes, config, gpu=args.visible))
